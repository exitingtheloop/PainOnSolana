...
function EdoTensei() {
  ...
  for (let i = 0; i < 200; i++) {
    triangles.push(<div className="tri"></div>);
  }

  return <div className="edowrap">{triangles}</div>;
}
...
function TickerTape() {
  ...
  for (let i = 0; i < 10; i++) {
    tickerDivs.push(<div className="ticker__item">#PainOnSOL</div>);
  }

  return (
    <div className="ticker-wrap">
      <div className="ticker">{tickerDivs}</div>
    </div>
  );
}
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  ...
                  <p>
                    Short for Popcorn, Pop is my nickname! a fabulous, pampered
                    Maltese who lives life like a true princess. Surrounded by
                    devoted admirers who woof her to the moon and back, Pop's
                    royal lifestyle is nothing short of majestic. The base meme
                    image was snapped with Pop's full awareness that she was
                    about to indulge the Solana meme space, her cheeky grin says
                    it all! Pop isn't like any other meme, it's a celebration of
                    sass, style, and a whole lot of fluff!
                  </p>
